...
//incluir dev-functions.js

function functions_js_dev(){

	wp_enqueue_script('functions.dev.js',

					get_stylesheet_directory_uri().'/js/functions-dev.js',
					array(),
					'1.0.0'
					);
...
add_action('wp_enqueue_scripts', 'functions_js_dev');
